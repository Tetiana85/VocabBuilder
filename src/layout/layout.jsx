...
export default function Layout() {
  ...
  // Пример функции открытия модального окна добавления слова
  const handleOpenModalAddWord = () => setIsModalOpenAddWord(true);
  const handleCloseModalAddWord = () => setIsModalOpenAddWord(false);
