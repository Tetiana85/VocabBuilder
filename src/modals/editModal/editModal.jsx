...
//   if (!clickWord) return null; // Return early if clickWord is not defined
...
//         en: clickWord?.en || '',
//         ua: clickWord?.ua || '',
//         category: clickWord?.category || '',
//         isIrregular: clickWord?.isIrregular || false,
//       },
//       validationSchema: EditWordSchema,
//       onSubmit: (values) => {
//         dispatch(editWord({ edit: values, id: clickWord._id })).then(
//           (response) => {
//             if (!response.error) {
//               handleClickClose();
//               console.log('Слово обновлено:', response.payload);
